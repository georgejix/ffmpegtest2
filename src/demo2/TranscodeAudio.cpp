                                  ...
                                  int frame_size)
{
     ...
     */
    void *a = calloc(output_codec_context->channels,
            sizeof(**converted_input_samples));
    *converted_input_samples = (uint8_t **)a;
...
void transcodeAudio(const char *in, const char *out)
{
	...
	AVFormatContext *input_format_context = NULL, *output_format_context = NULL;
	    ...
	    if (open_input_file(in, &input_format_context,
	                        &input_codec_context))
	        goto cleanup;
	    /* Open the output file for writing. */
	    if (open_output_file(out, input_codec_context,
